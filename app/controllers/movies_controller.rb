class MoviesController < ApplicationController
  ...
  def index
    ...
    #@indexSort = params[:indexSort]
    #params[:ratings].nil? ? rate_param = @all_ratings : rate_param = params[:ratings].keys
    #@movies = Movie.where(rating: rate_param).order(@indexSort)
